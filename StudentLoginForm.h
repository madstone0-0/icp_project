...
namespace icpproject {
    ...
    /// </summary>
   public
    ref class StudentLoginForm : public System::Windows::Forms::Form {
       private:
        IChildHost ^ parent;
       ...
       public:
        ...
        StudentLoginForm(IChildHost ^ parent) {
            this->parent = parent;
            InitializeComponent();
        }
...
#pragma region Windows Form Designer generated code
        ...
        void InitializeComponent(void) {
            ...
            this->loginButton->Click += gcnew System::EventHandler(this, &StudentLoginForm::loginButton_Click);
            //
            // passwordTB
            //
...
#pragma endregion
       private:
        System::Void loginButton_Click(System::Object ^ sender, System::EventArgs ^ e) {
            try {
                auto studentService = gcnew StudentService();
                ...
                if (isValid) {
                    auto res = studentService->Login(LoginUser{em, pass});
